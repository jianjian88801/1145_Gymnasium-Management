...
var centerMenu = [
    ...
    ,{
        name: '场地预约',
        url: '../changdiOrder/list.html'
    }
    ,{
        name: '赛事收藏',
        url: '../saishiCollection/list.html'
    }
    ,{
        name: '赛事订单',
        url: '../saishiOrder/list.html'
    }
    ,{
        name: '商品收藏',
...
var adminurl =  "http://localhost:8080/tiyuguanguanli/admin/dist/index.html#/login";
