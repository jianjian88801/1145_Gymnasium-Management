    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="现价" prop="shangpinNewMoney">
                       <el-input v-model="ruleForm.shangpinNewMoney"
                                 placeholder="现价" clearable  :readonly="ro.shangpinNewMoney"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="现价" prop="shangpinNewMoney">
                           <el-input v-model="ruleForm.shangpinNewMoney"
