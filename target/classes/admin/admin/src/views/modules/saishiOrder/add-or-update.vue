    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="24" v-if="sessionTable !='saishi' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.saishiPhoto" label="赛事照片" prop="saishiPhoto">
                        <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (saishiForm.saishiPhoto || '').split(',')" :src="item" width="100" height="100">
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.saishiPhoto" label="赛事照片" prop="saishiPhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.saishiPhoto || '').split(',')" :src="item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='saishi' ">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="订单号" prop="saishiOrderUuidNumber">
                       <el-input v-model="ruleForm.saishiOrderUuidNumber"
                                 placeholder="订单号" clearable  :readonly="ro.saishiOrderUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="订单号" prop="saishiOrderUuidNumber">
                           <el-input v-model="ruleForm.saishiOrderUuidNumber"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="实付价格" prop="saishiOrderTruePrice">
                       <el-input v-model="ruleForm.saishiOrderTruePrice"
                                 placeholder="实付价格" clearable  :readonly="ro.saishiOrderTruePrice"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="实付价格" prop="saishiOrderTruePrice">
                           <el-input v-model="ruleForm.saishiOrderTruePrice"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="订单类型" prop="saishiOrderTypes">
                        <el-select v-model="ruleForm.saishiOrderTypes" :disabled="ro.saishiOrderTypes" placeholder="请选择订单类型">
                            <el-option
                                v-for="(item,index) in saishiOrderTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="订单类型" prop="saishiOrderValue">
                        <el-input v-model="ruleForm.saishiOrderValue"
                            placeholder="订单类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="支付类型" prop="saishiOrderPaymentTypes">
                        <el-select v-model="ruleForm.saishiOrderPaymentTypes" :disabled="ro.saishiOrderPaymentTypes" placeholder="请选择支付类型">
                            <el-option
                                v-for="(item,index) in saishiOrderPaymentTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else>
                        <el-form-item class="input" label="支付类型" prop="saishiOrderPaymentValue">
                        <el-input v-model="ruleForm.saishiOrderPaymentValue"
    ...
    export default {
        data() {
            return {
                ...
                yonghuForm: {},
                ro:{
                    saishiOrderUuidNumber: false,
                    saishiId: false,
                    yonghuId: false,
                    saishiOrderTruePrice: false,
                    saishiOrderTypes: false,
                    saishiOrderPaymentTypes: false,
                    buyZuoweiNumber: false,
                    buyZuoweiTime: false,
                    insertTime: false,
                },
                ruleForm: {
                    saishiOrderUuidNumber: new Date().getTime(),
                    saishiId: '',
                    yonghuId: '',
                    saishiOrderTruePrice: '',
                    saishiOrderTypes: '',
                    saishiOrderPaymentTypes: '',
                    buyZuoweiNumber: '',
                    buyZuoweiTime: '',
                    insertTime: '',
                },
                saishiOrderTypesOptions : [],
                saishiOrderPaymentTypesOptions : [],
                saishiOptions : [],
                yonghuOptions : [],
                rules: {
                   saishiOrderUuidNumber: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=saishi_order_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.saishiOrderTypesOptions = data.data.list;
                    }
                });
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=saishi_order_payment_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.saishiOrderPaymentTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`saishiOrder/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.saishiOrderCrossAddOrUpdateFlag = false;
                                        this.parent.search();
