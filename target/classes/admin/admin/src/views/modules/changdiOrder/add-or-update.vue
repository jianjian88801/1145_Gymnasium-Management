            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='changdi'">
                    <el-form-item class="select" v-if="type!='info'"  label="场地" prop="changdiId">
                        <el-select v-model="ruleForm.changdiId" :disabled="ro.changdiId" filterable placeholder="请选择场地" @change="changdiChange">
                            <el-option
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="预约单号" prop="changdiOrderUuidNumber">
                       <el-input v-model="ruleForm.changdiOrderUuidNumber"
                                 placeholder="预约单号" clearable  :readonly="ro.changdiOrderUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="预约单号" prop="changdiOrderUuidNumber">
                           <el-input v-model="ruleForm.changdiOrderUuidNumber"
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="订单类型" prop="changdiOrderTypes">
                        <el-select v-model="ruleForm.changdiOrderTypes" :disabled="ro.changdiOrderTypes" placeholder="请选择订单类型">
                            <el-option
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="支付类型" prop="changdiOrderPaymentTypes">
                        <el-select v-model="ruleForm.changdiOrderPaymentTypes" :disabled="ro.changdiOrderPaymentTypes" placeholder="请选择支付类型">
                            <el-option
                                v-for="(item,index) in changdiOrderPaymentTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else>
                        <el-form-item class="input" label="支付类型" prop="changdiOrderPaymentValue">
                        <el-input v-model="ruleForm.changdiOrderPaymentValue"
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    ...
                    changdiOrderPaymentTypes: false,
                    yuyueTime: false,
                    insertTime: false,
                },
                ruleForm: {
                    ...
                    changdiOrderTypes: '',
                    changdiOrderPaymentTypes: '',
                    yuyueTime: '',
                    insertTime: '',
                },
                changdiOrderTypesOptions : [],
                changdiOrderPaymentTypesOptions : [],
                changdiOptions : [],
                yonghuOptions : [],
                rules: {
        ...
        created() {
            ...
            //获取下拉框信息
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=changdi_order_payment_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.changdiOrderPaymentTypesOptions = data.data.list;
                    }
                });
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.changdiChange(data.data.changdiId)
