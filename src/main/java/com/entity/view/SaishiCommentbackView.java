...
public class SaishiCommentbackView extends SaishiCommentbackEntity implements Serializable {
	...
	public SaishiCommentbackView() {

	}

	public SaishiCommentbackView(SaishiCommentbackEntity saishiCommentbackEntity) {
		try {
			BeanUtils.copyProperties(this, saishiCommentbackEntity);
