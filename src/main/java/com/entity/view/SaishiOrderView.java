...
public class SaishiOrderView extends SaishiOrderEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 订单类型的值
		*/
		private String saishiOrderValue;
		/**
		* 支付类型的值
		*/
		private String saishiOrderPaymentValue;
	...
	public SaishiOrderView() {

	}

	public SaishiOrderView(SaishiOrderEntity saishiOrderEntity) {
		try {
			BeanUtils.copyProperties(this, saishiOrderEntity);
			...
			* 获取： 订单类型的值
			*/
			public String getSaishiOrderValue() {
				return saishiOrderValue;
			}
			/**
			* 设置： 订单类型的值
			*/
			public void setSaishiOrderValue(String saishiOrderValue) {
				this.saishiOrderValue = saishiOrderValue;
			}
			/**
			* 获取： 支付类型的值
			*/
			public String getSaishiOrderPaymentValue() {
				return saishiOrderPaymentValue;
			}
			/**
			* 设置： 支付类型的值
			*/
			public void setSaishiOrderPaymentValue(String saishiOrderPaymentValue) {
				this.saishiOrderPaymentValue = saishiOrderPaymentValue;
			}
