        ...
        <div v-if="showFlag">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/tiyuguanguanli/upload/shangpinCollectionMuBan.xls"
                        >批量导入商品收藏数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('shangpinCollection','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="shangpinCollectionTypes"
                                      header-align="center"
                                      label="类型">
                        <template slot-scope="scope">
                            {{scope.row.shangpinCollectionValue}}
                        </template>
                    </el-table-column>
        ...
        methods: {
            chartDialog() {
                ...
                let params = {
                    ...
                    thisTable : {//当前表
                        tableName :"shangpin_collection",//当前表表名,
                        sumColum : 'shangpin_collection_number', //求和字段
                        date : 'insert_time',//分组日期字段
                        // string : 'shangpin_collection_name',//分组字符串字段
                        // types : 'shangpin_collection_types',//分组下拉框字段
                    },
                    // joinTable : {//级联表（可以不存在）
                ...
                //         groupColumn: "shangpin_collection_types",
                //     }
                //     this.$http({
