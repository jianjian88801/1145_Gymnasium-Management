    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="类型" prop="saishiCollectionTypes">
                        <el-select v-model="ruleForm.saishiCollectionTypes" :disabled="ro.saishiCollectionTypes" placeholder="请选择类型">
                            <el-option
                                v-for="(item,index) in saishiCollectionTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="类型" prop="saishiCollectionValue">
                        <el-input v-model="ruleForm.saishiCollectionValue"
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    saishiId: false,
                    yonghuId: false,
                    saishiCollectionTypes: false,
                    insertTime: false,
                },
                ruleForm: {
                    saishiId: '',
                    yonghuId: '',
                    saishiCollectionTypes: '',
                    insertTime: '',
                },
                saishiCollectionTypesOptions : [],
                saishiOptions : [],
                yonghuOptions : [],
                rules: {
                   saishiId: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=saishi_collection_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.saishiCollectionTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`saishiCollection/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.saishiCollectionCrossAddOrUpdateFlag = false;
                                        this.parent.search();
