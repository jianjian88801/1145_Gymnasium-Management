    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="场地类型" prop="changdiTypes">
                        <el-select v-model="ruleForm.changdiTypes" :disabled="ro.changdiTypes" placeholder="请选择场地类型">
                            <el-option
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="预约原价格/天" prop="changdiOldMoney">
                       <el-input v-model="ruleForm.changdiOldMoney"
                                 placeholder="预约原价格/天" clearable  :readonly="ro.changdiOldMoney"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="预约原价格/天" prop="changdiOldMoney">
                           <el-input v-model="ruleForm.changdiOldMoney"
                                     placeholder="预约原价格/天" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="现价/天" prop="changdiNewMoney">
                       <el-input v-model="ruleForm.changdiNewMoney"
                                 placeholder="现价/天" clearable  :readonly="ro.changdiNewMoney"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="现价/天" prop="changdiNewMoney">
                           <el-input v-model="ruleForm.changdiNewMoney"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="场地介绍" prop="changdiContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.changdiContent" label="场地介绍" prop="changdiContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   changdiOldMoney: [
                              { required: true, message: '预约原价格/天不能为空', trigger: 'blur' },
                   ...
                   changdiContent: [
                              { required: true, message: '场地介绍不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
