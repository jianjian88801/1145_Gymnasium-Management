    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="赛事名称" prop="saishiName">
                       <el-input v-model="ruleForm.saishiName"
                                 placeholder="赛事名称" clearable  :readonly="ro.saishiName"></el-input>
                   </el-form-item>
                   <div v-else>
                ...
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.saishiPhoto" label="赛事照片" prop="saishiPhoto">
                        <file-upload
                            ...
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.saishiPhoto?ruleForm.saishiPhoto:''"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="赛事类型" prop="saishiTypes">
                        <el-select v-model="ruleForm.saishiTypes" :disabled="ro.saishiTypes" placeholder="请选择赛事类型">
                            <el-option
                                v-for="(item,index) in saishiTypesOptions"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="赛事原价" prop="saishiOldMoney">
                       <el-input v-model="ruleForm.saishiOldMoney"
                                 placeholder="赛事原价" clearable  :readonly="ro.saishiOldMoney"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="赛事原价" prop="saishiOldMoney">
                           <el-input v-model="ruleForm.saishiOldMoney"
                                     placeholder="赛事原价" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="现价" prop="saishiNewMoney">
                       <el-input v-model="ruleForm.saishiNewMoney"
                                 placeholder="现价" clearable  :readonly="ro.saishiNewMoney"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="现价" prop="saishiNewMoney">
                           <el-input v-model="ruleForm.saishiNewMoney"
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="赛事介绍" prop="saishiContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.saishiContent" label="赛事介绍" prop="saishiContent">
                            <span v-html="ruleForm.saishiContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   saishiPhoto: [
                              { required: true, message: '赛事照片不能为空', trigger: 'blur' },
                          ],
                   saishiTypes: [
                   ...
                   saishiOldMoney: [
                              { required: true, message: '赛事原价不能为空', trigger: 'blur' },
        ...
        created() {
            ...
            if (this.role != "管理员"){
                this.ro.saishiOldMoney = true;
                this.ro.saishiNewMoney = true;
            }
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=saishi_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`saishi/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.saishiCrossAddOrUpdateFlag = false;
                                        this.parent.search();
